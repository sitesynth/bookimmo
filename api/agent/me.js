...
export default async function handler(req, res) {
  ...
  return res.status(200).json({
    agent: {
      ...
      accountType: agent.agentProfile.account_type || 'independent',
      phone: agent.agentProfile.phone || '',
      avatarUrl: agent.agentProfile.avatar_url || '',
      countryCode: agent.agentProfile.country_code || '',
      countryName: agent.agentProfile.country_name || '',
      baseCityId: agent.agentProfile.base_city_id || '',
      baseCity: agent.agentProfile.base_city || '',
      baseCityRegion: agent.agentProfile.city_region || '',
      ...
      organization: agent.agentProfile.organization_id ? {
        id: agent.agentProfile.organization_id,
        name: agent.agentProfile.organization_name || '',
        website: agent.agentProfile.organization_website || '',
      } : null,
